...
final class SentMessageTVC: UITableViewCell {
    ...
    private let messageView: SentMessageView = {
...
extension SentMessageTVC {
    ...
    func createViews() {
        ...
        NSLayoutConstraint(item: messageView, attribute: .leading, relatedBy: .greaterThanOrEqual, toItem: containerView, attribute: .leading, multiplier: 1, constant: 70).isActive = true
    }
}
